...
export function Sources() {
  return (
    <section className="wrap py-14 md:py-16">
      <h2 className="text-center text-base font-medium text-muted-foreground">Already reading imagery from every major feed</h2>
      <ul className="mt-8 flex flex-wrap justify-center gap-3 text-base font-medium">
